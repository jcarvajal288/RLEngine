...
namespace rlns
{
    ...
    --------------------------------------------------------------------------------*/
    static bool movePlayer(const DirectionType dir, const DisplayPtr display) 
    {
        LevelPtr currentLevel = Level::getCurrentLevel();
        ActorPtr player = Party::getPlayerParty()->getLeader();
    ...
    --------------------------------------------------------------------------------*/
    static bool pickUpItem(const DisplayPtr display) 
    {
        LevelPtr currentLevel = Level::getCurrentLevel();
        ActorPtr player = Party::getPlayerParty()->getLeader();
    ...
    /*--------------------------------------------------------------------------------
        ...
        Return      : bool (whether the action performed in the inventory screen costs
                      a turn)
    --------------------------------------------------------------------------------*/
    bool showInventory(const DisplayPtr display)
    {
    ...
    --------------------------------------------------------------------------------*/
    bool mainEventContext(const EventType event, const DisplayPtr display)
    {
