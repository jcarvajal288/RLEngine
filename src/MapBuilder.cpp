...
namespace rlns
{
    namespace model
    {
        ...
        /*--------------------------------------------------------------------------------
            ...
            Return      : int
        --------------------------------------------------------------------------------*/
        int getBorderCode(const MapPtr map, const utl::Point& center, const int ch)
        {
        ...
        /*--------------------------------------------------------------------------------
            ...
            Return      : int
        --------------------------------------------------------------------------------*/
        int getBorderCode(const MapPtr map, const utl::Point& center, const vector<int>& ids)
        {
            // get center Point coordinates
            int x = center.X();
            int y = center.Y();
        ...
        /*--------------------------------------------------------------------------------
            ...
            Return      : int
        --------------------------------------------------------------------------------*/
        int numNeighbors(const MapPtr map, const utl::Point& center, const int ch)
        {
            // get center Point coordinates
            int x = center.X();
            int y = center.Y();
