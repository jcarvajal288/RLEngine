    ...
    namespace model
    {
        ...
        class MenuScreen
        {
            ...
            protected:
                ...
                utl::Point drawFolders(int&, int&, const utl::Point&, 
                                           const std::vector< std::pair<int, TCODColor> >&);
                void drawScrollBar(const utl::Point&, const int, const int, const int, const bool vert=true);
            ...
            public: 
                MenuScreen(const view::DisplayPtr _display)
        ...
        class InventoryScreen: public MenuScreen
        {
            ...
            public:
                InventoryScreen(const view::DisplayPtr _display, const ActorPtr c)
                : MenuScreen(_display), client(c) {}

                void interpretEvent(const control::EventType);
